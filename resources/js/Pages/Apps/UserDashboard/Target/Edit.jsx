            ...
            try {
                ...
                if (response.data.target) {
                    ...
                    setData({
                        ...
                        total_target: response.data.target.min_target || MIN_TARGET
                    });
                } else {
                    setData(prev => ({
                        ...prev,
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="mt-30">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="absolute inset-0 w-[379px] h-[34px] opacity-0 cursor-pointer"
                                />
                            </div>
                        ...
                        <div className="flex justify-end space-x-2 mt-8">
                            <button
                                ...
                                className="w-[120px] h-[40px] bg-white border border-[#AA51DF] text-black rounded-md transition-colors duration-200 hover:bg-gray-50 dark:bg-white dark:hover:bg-gray-50 dark:text-black"
                            >
                                Batal
                            </button>
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-[120px] h-[40px] bg-[#AA51DF] hover:bg-[#9539D2] text-white rounded-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed dark:bg-[#AA51DF] dark:hover:bg-[#9539D2]"
                            >
